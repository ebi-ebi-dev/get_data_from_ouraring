...
# python .\src\daily_readiness.py -configfile_path "C:\Workspace\python\oura_ring\get_data_from_ouraring\config\config.ini" -start_date 2024-08-01 -end_date 2024-08-10 -output_path "C:/Workspace/python/oura_ring/get_data_from_ouraring/output"
...
logger.info("start daily_readiness")
...
def main():
    ...
    while(status_code == 200 and next_token_flag is True):
        ...
        if(res.status_code == 200):
            ...
            output_file_path = args.output_path + "/daily_readiness_" + args.start_date + "~" + args.end_date + ".csv"
