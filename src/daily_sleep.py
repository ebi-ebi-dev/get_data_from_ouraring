...
# python .\src\daily_sleep.py -configfile_path "C:\Workspace\python\oura_ring\get_data_from_ouraring\config\config.ini" -start_date 2024-08-01 -end_date 2024-08-10 -output_path "C:/Workspace/python/oura_ring/get_data_from_ouraring/output"
...
def main():
    ...
    while(status_code == 200 and next_token_flag is True):
        ...
        if(res.status_code == 200):
            ...
            output_file_path = args.output_path + "/daily_sleep_" + args.start_date + "~" + args.end_date + ".csv"
